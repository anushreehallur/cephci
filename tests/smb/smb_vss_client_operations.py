    ...
    try:
        ...
        for operation in operations:
            if operation == "create_file":
                create_files(client, mount_point, file_count, windows_client)

            elif operation == "update_file":
                rename_file(client, mount_point, file_count, windows_client)

            elif operation == "list_previous_versions":
                rename_file(clients[int(client[-2:]) - 1],
                            mount_point,
                            file_count,
                            windows_client)
                ...
                remove_files(clients[int(client[-2:]) - 1],
                            mount_point,
                            file_count,
                            windows_client)
